...
The final stock score is a weighted blend of three pillars, each scored from **-100 to +100**:
...
**Example:** A composite score of +56 means the stock is moderately bullish across all three pillars (56 out of 100).
...
- 0-24 (Extreme Fear): +100 (contrarian buy)
- 25-44 (Fear): +50
- 45-55 (Neutral): 0
- 56-74 (Greed): -50
- 75-100 (Extreme Greed): -100 (contrarian sell)
...
- Compute Net Liquidity in trillions. Then assess the **3-month trend**:
  - Rising more than 3%: +100
  - Rising 1-3%: +50
  - Flat (plus or minus 1%): 0
  - Falling 1-3%: -50
  - Falling more than 3%: -100

**Indicator 3: Chicago Fed NFCI (negative = loose, positive = tight)**
- Below -0.50: +100 (very loose, bullish)
- -0.50 to -0.25: +50 (loose)
- -0.25 to +0.25: 0 (neutral)
- +0.25 to +0.50: -50 (tightening)
- Above +0.50: -100 (tight, bearish)

**Indicator 4: Baltic Dry Index (BDI) — assess 3-month trend direction**
- Rising more than 20%: +100
- Rising 5-20%: +50
- Flat (plus or minus 5%): 0
- Falling 5-20%: -50
- Falling more than 20%: -100

**Indicator 5: ISM Manufacturing New Orders**
- Above 55: +100 (expansion)
- 52-55: +50
- 48-52: 0 (neutral)
- 45-48: -50
- Below 45: -100 (contraction)

**Indicator 6: US LEI (Conference Board Leading Economic Index, MoM % change)**
- Positive and rising: +100
- Positive but slowing: +50
- Flat or mixed: 0
- Negative but improving: -50
- Negative and declining: -100

**Indicator 7: US 10Y-2Y Treasury Yield Spread**
- Steep positive (more than +100bps): +100 (accommodative)
- Spread normalizing from inversion (more than +25bps): +50
- Normal positive spread (0 to +25bps): 0
- Inverted (-25bps to 0): -50
- Deeply inverted (less than -25bps): -100
...
|-------------------|---------------|---------|
| +40 to +100 | MACRO BUY | Bullish — tailwinds for equities |
| +10 to +39 | MACRO LEAN-BUY | Mildly supportive |
| -9 to +9 | MACRO NEUTRAL | No strong macro signal |
| -39 to -10 | MACRO LEAN-SELL | Caution — headwinds building |
| -100 to -40 | MACRO SELL | Bearish — risk-off environment |
...
- MACD above signal AND histogram rising for 5+ days: +100
- MACD above signal AND histogram flat or just turned positive: +50
- MACD near signal line (histogram near zero, no clear trend): 0
- MACD below signal AND histogram flat or just turned negative: -50
- MACD below signal AND histogram falling for 5+ days: -100

**Indicator 2: EMA Cross (10/30)**
Compare the 10-day EMA vs. 30-day EMA for short-term momentum:
- EMA10 above EMA30 AND gap widening (bullish crossover occurred within last 5 days): +100
- EMA10 above EMA30 AND gap stable: +50
- EMA10 approximately equals EMA30 (within 0.5%): 0
- EMA10 below EMA30 AND gap stable: -50
- EMA10 below EMA30 AND gap widening (bearish crossover within last 5 days): -100

**Indicator 3: RSI (14-day)**
- Below 20 (deeply oversold): +100 (contrarian buy)
- 20-30 (oversold): +50
- 30-50 (weakening but not oversold): -25
- 50-70 (healthy momentum): +25
- 70-80 (overbought territory): -50
- Above 80 (deeply overbought): -100 (contrarian sell)
...
- J below 0 AND K crossing above D (golden cross in oversold): +100
- K above D AND J between 0-50 (bullish but not overextended): +50
- K approximately equals D (no clear signal): 0
- K below D AND J between 50-100 (bearish but not oversold): -50
- J above 100 AND K crossing below D (death cross in overbought): -100
...
- Price rising on increasing volume (healthy rally): +100
- Price rising on stable/slightly declining volume (momentum fading but still positive): +50
- No clear price-volume pattern: 0
- Price falling on stable/slightly increasing volume (distribution beginning): -50
- Price falling on increasing volume (heavy distribution / panic selling): -100

**Indicator 6: EMA Trend Structure (20/50/200)** *(Weight: 15%)*
Assess the alignment of 20-day, 50-day, and 200-day EMA:
- Price above EMA20 above EMA50 above EMA200 (perfect bullish alignment): +100
- Price above EMA50 above EMA200, but below EMA20 (minor pullback in uptrend): +50
- Mixed alignment, no clear trend: 0
- Price below EMA50 but above EMA200 (weakening, potential trend change): -50
- Price below EMA20 below EMA50 below EMA200 (perfect bearish alignment): -100
...
**Scoring:**
- Class A fully met (all 4/4 conditions): **+100** (strong structural buy signal)
- Class B fully met (all 4/4 conditions): **+100** (strong pullback buy signal)
- Either class partially met (3 of 4 conditions): **+50** (emerging buy structure)
- Neither class conditions met, but no breakdown signals: **0** (no structural signal)
- Anti-pattern: price breaking below 200MA on rising volume, or failed breakout with gap-down: **-50** (structural deterioration)
- Anti-pattern: price below all major MAs, weekly downtrend accelerating on heavy volume: **-100** (structural breakdown)

> **Note:** If both Class A and Class B are fully met simultaneously, score +100 (do not double-count). If one class is fully met and the other is partially met, still score +100.
...
|-----------------------|------------------|---------|
| +40 to +100 | TECH BULLISH | Strong momentum and trend support |
| +10 to +39 | TECH LEAN-BULLISH | Mildly positive technicals |
| -9 to +9 | TECH NEUTRAL | No clear technical signal |
| -39 to -10 | TECH LEAN-BEARISH | Weakening momentum |
| -100 to -40 | TECH BEARISH | Strong downtrend / negative momentum |
...
Convert the fundamental analysis into a score from **-100 to +100**:

| Fundamental Assessment | Score |
|------------------------|-------|
| Strong fundamentals, attractive valuation, positive catalysts | +70 to +100 |
| Good fundamentals, reasonable valuation | +30 to +60 |
| Mixed fundamentals, fair valuation | -20 to +20 |
| Weakening fundamentals, rich valuation | -60 to -30 |
| Poor fundamentals, overvalued, negative catalysts | -100 to -70 |
